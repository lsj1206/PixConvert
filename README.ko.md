...
실행에는 `PixConvert.exe`와 `libvips-42.dll`이 같은 폴더에 있으면 됩니다.
릴리스에서는 라이선스 및 재배포 고지를 위해 `LICENSE`와 `THIRD-PARTY-NOTICES.md`도 함께 포함됩니다.
...
- 개발 일지: [바로가기](https://lsj1206.github.io/post/05/)
